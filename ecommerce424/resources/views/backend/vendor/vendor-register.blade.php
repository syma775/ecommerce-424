...
<div class="form_wrapper">
  <div class="form_container">
            @if(session()->has('success'))
              <div class="btn btn-block btn-success" style="text-align:center;color:green;">{{ session()->get('success') }}</div>
            @endif
    ...
    <div class="row clearfix">
      <div class="">
        <form action="{{ url('/vendor/store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
              <label class="input_field" style="font-style:40">Logo/Avatar</label>
              <input type="file" name="image" class="input_field" />
          </div>
