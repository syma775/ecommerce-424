  ...
  <div class="col-md-12">
    <div class="row">
     ...
     @if(session()->has('success'))
					          ...
					          @endif
     <div class="card">
      <h3 style="margin-top:30px; margin-bottom:20px;text-align:center;">Vendor Login</h3>
					<form action="{{ url('/vendor/login/form') }}" method="POSt" style="margin-left:50px;margin-right:50px;">
						@csrf
          ...
          <a href="{{ url('/vendor/register') }}" style="text-align:center">Create an Account. Register</a>
      </div>
     </div>
      <div class="col-md-3"></div>
    </div>
