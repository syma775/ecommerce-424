         ...
         @endif
           <form action="{{ url('/vendor/product/store')}}" method="post" enctype="multipart/form-data">
            ...
            <!-- <div class="form-group">
              ...
              <div class="form-group">
                <label>Size</label>
                <input type="text" name="size" class="form-control" placeholder="please enter Product name"/>
                    
              </div>

              <div class="form-group">
                <label>Brand</label>
                <input type="text" name="brand" class="form-control" placeholder="please enter Product name"/>
              </div>
              ...
              <input type="text" name="qty" class="form-control" placeholder="please enter Product name"/>
              </div>
             ...
             <button type="submit" class="btn btn-block btn-success" style="margin-bottom:30px;margin-top:40px;">Add</button>
           ...
           <button class="btn btn-sm btn-primary"  style="float:left;margin-top:20px;margin-bottom:20px;"><a style=" color:white;text-decoration:none"href="{{ url('/vendor/dashboard') }}">Dashboard</a></button>
